...
<html lang="en">
<head>
    <title>Strutted™ - View Image</title>
    <meta charset="UTF-8"/>
...
<div class="page-wrapper">
    ...
    <div class="content-wrapper">
        <div class="success-container">
            <div class="messages">
                <img src="<s:property value='imagePath'/>" alt="Uploaded Image"/>
            </div>

            <div class="back-link">
                <s:url var="uploadActionUrl" action="upload"/>
                <a href="<s:property value='#uploadActionUrl'/>" class="btn btn-outline-secondary">Upload An Image</a>
            </div>
        </div>
    </div>
