    ...
    <div class="content-wrapper">
        ...
        <div class="aboutus-container">
            ...
            <div class="aboutus-section">
                ...
                <img src="https://via.placeholder.com/800x400.png?text=Our+Team" alt="Our Team">
            </div>
            ...
            <div class="aboutus-section">
                ...
                <img src="https://via.placeholder.com/800x400.png?text=Our+Services" alt="Our Services">
            </div>
            ...
            <div class="aboutus-section">
                ...
                <img src="https://via.placeholder.com/800x400.png?text=Our+Vision" alt="Our Vision">
            </div>

            <div class="aboutus-section">
                <h3>Why Choose Us</h3>
                <p>
                    - **Security:** We prioritize the safety of your images with advanced encryption and secure storage solutions.
                    <br>
                    - **Simplicity:** Our user-friendly interface makes uploading and sharing images a breeze.
                    <br>
                    - **Reliability:** With 99.9% uptime and robust infrastructure, your images are always accessible when you need them.
                    <br>
                    - **Support:** Our dedicated support team is here to assist you with any queries or issues.
                </p>
